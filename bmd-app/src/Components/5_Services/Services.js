        ...
        <div className="services-cards">
          ...
          <ServicesCard
            ...
            detail={[
              ...
              <ul>
                <li>
                  Initial inspection and report of entire bike and all
                  components - NB some issues (eg internal condition of
                  bearings) may not be identified if they require work that is
                  not included below
                </li>
                <li>
                ...
                <li>
                  Adjustment of wheel, bottom bracket and headset bearings
                </li>
                <li>
                  Quick clean of frame, forks and drivetrain to inspect parts
                  for damage (removal of excessive dirt for this purpose may
                  incur a cleaning charge)
                </li>
                <li>
                  Adjustment of the saddle, handlebars and other accessories
                  where required.
                </li>
              </ul>,
          ...
          <ServicesCard
            ...
            detail={[
              ...
              <p>
                ...
                bike. We remove every component down to the frame and forks,
                clean everything meticulously including the drivetrain, service
                all headset, bottom bracket and wheel bearings, bleed hydraulic
                brakes and re-fit every part with the correct lubricants/grease
                etc. The bike is then setup and test ridden for perfection.
              </p>,
              <p>
